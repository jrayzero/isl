...
pkgdatadir = $(datadir)/isl
pkgincludedir = $(includedir)/isl
pkglibdir = $(libdir)/isl
pkglibexecdir = $(libexecdir)/isl
...
TESTS = isl_test$(EXEEXT) codegen_test.sh pip_test.sh bound_test.sh \
	...
	$(am__EXEEXT_1)
#am__append_1 = isl_test_imath
#am__append_2 = isl_test_imath
##am__append_3 = isl_int_sioimath.h \
##	isl_int_sioimath.c \
##	isl_val_sioimath.c

#am__append_4 = isl_val_imath.c
subdir = .
...
#am__objects_1 = mp_get_memory_functions.lo
...
#am__objects_3 =  \
#	isl_val_imath.lo
##am__objects_4 = isl_imath.lo \
##	imath_wrap/gmp_compat.lo \
##	imath_wrap/imath.lo \
##	imath_wrap/imrat.lo \
##	$(am__objects_2) \
##	$(am__objects_3)
am__objects_4 = $(am__objects_1) isl_gmp.lo \
	isl_val_gmp.lo
am_libisl_la_OBJECTS = $(am__objects_4) isl_aff.lo isl_affine_hull.lo \
	...
	isl_stream.lo isl_seq.lo isl_tab.lo isl_tab_pip.lo \
	isl_tarjan.lo isl_transitive_closure.lo isl_union_map.lo \
	isl_val.lo isl_vec.lo isl_version.lo isl_vertices.lo
...
#am__EXEEXT_1 = isl_test_imath$(EXEEXT)
...
#isl_test_imath_DEPENDENCIES = libisl.la
...
ACLOCAL = ${SHELL} /Users/JRay/ClionProjects/tiramisu/3rdParty/isl/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /Users/JRay/ClionProjects/tiramisu/3rdParty/isl/missing autoconf
AUTOHEADER = ${SHELL} /Users/JRay/ClionProjects/tiramisu/3rdParty/isl/missing autoheader
AUTOMAKE = ${SHELL} /Users/JRay/ClionProjects/tiramisu/3rdParty/isl/missing automake-1.15
AWK = awk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /Users/JRay/ClionProjects/tiramisu/3rdParty/isl/missing makeinfo
MANIFEST_TOOL = :
...
VERSION = 0.18
WARNING_FLAGS = -Wall
abs_builddir = /Users/JRay/ClionProjects/tiramisu/3rdParty/isl
abs_srcdir = /Users/JRay/ClionProjects/tiramisu/3rdParty/isl
abs_top_builddir = /Users/JRay/ClionProjects/tiramisu/3rdParty/isl
abs_top_srcdir = /Users/JRay/ClionProjects/tiramisu/3rdParty/isl
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/JRay/ClionProjects/tiramisu/3rdParty/isl/install-sh
...
pkgconfig_libfile = isl.pc
pkgpyexecdir = ${pyexecdir}/isl
pkgpythondir = ${pythondir}/isl
prefix = /usr/local
...
#MP_SRC = isl_imath.c isl_imath.h isl_int_imath.h \
#	imath_wrap/gmp_compat.h imath_wrap/imath.h \
#	imath_wrap/imrat.h imath_wrap/wrap.h \
#	imath_wrap/gmp_compat.c imath_wrap/imath.c \
#	imath_wrap/imrat.c $(am__append_3) \
#	$(am__append_4)
MP_INCLUDE_H = include/isl/val_gmp.h
#MP_INCLUDE_H = 
#GET_MEMORY_FUNCTIONS = mp_get_memory_functions.c
AM_CPPFLAGS = -I. -I$(srcdir) -I$(srcdir)/include -Iinclude/ 
AM_CFLAGS = -Wall
libisl_la_SOURCES = \
	$(MP_SRC) \
	isl_aff.c \
...
libisl_la_LIBADD = -lgmp
libisl_la_LDFLAGS = -version-info 18:0:3 \
	

isl_test_LDFLAGS = 
isl_test_LDADD = libisl.la -lgmp
isl_test_int_LDFLAGS = 
isl_test_int_LDADD = libisl.la -lgmp
#isl_test_imath_LDFLAGS = 
#isl_test_imath_LDADD = libisl.la -lgmp
...
isl_schedule_LDFLAGS = 
isl_schedule_LDADD = libisl.la -lgmp
isl_schedule_SOURCES = \
	schedule.c

isl_schedule_cmp_LDFLAGS = 
isl_schedule_cmp_LDADD = libisl.la -lgmp
isl_schedule_cmp_SOURCES = \
	schedule_cmp.c

isl_flow_LDFLAGS = 
isl_flow_LDADD = libisl.la -lgmp
isl_flow_SOURCES = \
	flow.c

isl_flow_cmp_LDFLAGS = 
isl_flow_cmp_LDADD = libisl.la -lgmp
isl_flow_cmp_SOURCES = \
	flow_cmp.c

isl_codegen_LDFLAGS = 
isl_codegen_LDADD = libisl.la -lgmp
isl_codegen_SOURCES = \
	codegen.c
...
isl_polyhedron_minimize_LDFLAGS = 
...
include ./$(DEPDIR)/basis_reduction_tab.Plo
include ./$(DEPDIR)/bound.Po
include ./$(DEPDIR)/cat.Po
include ./$(DEPDIR)/closure.Po
include ./$(DEPDIR)/codegen.Po
include ./$(DEPDIR)/flow.Po
include ./$(DEPDIR)/flow_cmp.Po
include ./$(DEPDIR)/isl_aff.Plo
include ./$(DEPDIR)/isl_affine_hull.Plo
include ./$(DEPDIR)/isl_arg.Plo
include ./$(DEPDIR)/isl_ast.Plo
include ./$(DEPDIR)/isl_ast_build.Plo
include ./$(DEPDIR)/isl_ast_build_expr.Plo
include ./$(DEPDIR)/isl_ast_codegen.Plo
include ./$(DEPDIR)/isl_ast_graft.Plo
include ./$(DEPDIR)/isl_bernstein.Plo
include ./$(DEPDIR)/isl_blk.Plo
include ./$(DEPDIR)/isl_bound.Plo
include ./$(DEPDIR)/isl_coalesce.Plo
include ./$(DEPDIR)/isl_constraint.Plo
include ./$(DEPDIR)/isl_convex_hull.Plo
include ./$(DEPDIR)/isl_ctx.Plo
include ./$(DEPDIR)/isl_deprecated.Plo
include ./$(DEPDIR)/isl_dim_map.Plo
include ./$(DEPDIR)/isl_equalities.Plo
include ./$(DEPDIR)/isl_factorization.Plo
include ./$(DEPDIR)/isl_farkas.Plo
include ./$(DEPDIR)/isl_ffs.Plo
include ./$(DEPDIR)/isl_flow.Plo
include ./$(DEPDIR)/isl_fold.Plo
include ./$(DEPDIR)/isl_gmp.Plo
include ./$(DEPDIR)/isl_hash.Plo
include ./$(DEPDIR)/isl_id.Plo
include ./$(DEPDIR)/isl_id_to_ast_expr.Plo
include ./$(DEPDIR)/isl_id_to_id.Plo
include ./$(DEPDIR)/isl_id_to_pw_aff.Plo
include ./$(DEPDIR)/isl_ilp.Plo
include ./$(DEPDIR)/isl_imath.Plo
include ./$(DEPDIR)/isl_input.Plo
include ./$(DEPDIR)/isl_int_sioimath.Plo
include ./$(DEPDIR)/isl_local.Plo
include ./$(DEPDIR)/isl_local_space.Plo
include ./$(DEPDIR)/isl_lp.Plo
include ./$(DEPDIR)/isl_map.Plo
include ./$(DEPDIR)/isl_map_list.Plo
include ./$(DEPDIR)/isl_map_simplify.Plo
include ./$(DEPDIR)/isl_map_subtract.Plo
include ./$(DEPDIR)/isl_map_to_basic_set.Plo
include ./$(DEPDIR)/isl_mat.Plo
include ./$(DEPDIR)/isl_morph.Plo
include ./$(DEPDIR)/isl_obj.Plo
include ./$(DEPDIR)/isl_options.Plo
include ./$(DEPDIR)/isl_output.Plo
include ./$(DEPDIR)/isl_point.Plo
include ./$(DEPDIR)/isl_polynomial.Plo
include ./$(DEPDIR)/isl_printer.Plo
include ./$(DEPDIR)/isl_range.Plo
include ./$(DEPDIR)/isl_reordering.Plo
include ./$(DEPDIR)/isl_sample.Plo
include ./$(DEPDIR)/isl_scan.Plo
include ./$(DEPDIR)/isl_schedule.Plo
include ./$(DEPDIR)/isl_schedule_band.Plo
include ./$(DEPDIR)/isl_schedule_constraints.Plo
include ./$(DEPDIR)/isl_schedule_node.Plo
include ./$(DEPDIR)/isl_schedule_read.Plo
include ./$(DEPDIR)/isl_schedule_tree.Plo
include ./$(DEPDIR)/isl_scheduler.Plo
include ./$(DEPDIR)/isl_seq.Plo
include ./$(DEPDIR)/isl_set_list.Plo
include ./$(DEPDIR)/isl_sort.Plo
include ./$(DEPDIR)/isl_space.Plo
include ./$(DEPDIR)/isl_stream.Plo
include ./$(DEPDIR)/isl_tab.Plo
include ./$(DEPDIR)/isl_tab_pip.Plo
include ./$(DEPDIR)/isl_tarjan.Plo
include ./$(DEPDIR)/isl_test.Po
include ./$(DEPDIR)/isl_test_imath.Po
include ./$(DEPDIR)/isl_test_int.Po
include ./$(DEPDIR)/isl_transitive_closure.Plo
include ./$(DEPDIR)/isl_union_map.Plo
include ./$(DEPDIR)/isl_val.Plo
include ./$(DEPDIR)/isl_val_gmp.Plo
include ./$(DEPDIR)/isl_val_imath.Plo
include ./$(DEPDIR)/isl_val_sioimath.Plo
include ./$(DEPDIR)/isl_vec.Plo
include ./$(DEPDIR)/isl_version.Plo
include ./$(DEPDIR)/isl_vertices.Plo
include ./$(DEPDIR)/mp_get_memory_functions.Plo
include ./$(DEPDIR)/pip.Po
include ./$(DEPDIR)/polyhedron_detect_equalities.Po
include ./$(DEPDIR)/polyhedron_minimize.Po
include ./$(DEPDIR)/polyhedron_sample.Po
include ./$(DEPDIR)/polytope_scan.Po
include ./$(DEPDIR)/print.Plo
include ./$(DEPDIR)/schedule.Po
include ./$(DEPDIR)/schedule_cmp.Po
include imath_wrap/$(DEPDIR)/gmp_compat.Plo
include imath_wrap/$(DEPDIR)/imath.Plo
include imath_wrap/$(DEPDIR)/imrat.Plo
